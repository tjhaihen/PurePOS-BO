...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="default.aspx.vb" Inherits="Raven.Web.Secure.Transaction.DeliveryOrder"
                                    ...
                                    <td valign="top" width="100%">
                                        ...
                                        <%--<telerik:RadAjaxManager id="RadAjaxManager1" runat="server"  EnableOutsideScripts="True">
													<AjaxSettings>																												
														...
														<telerik:AjaxSetting AjaxControlID="RadGridDeliveryOrder">
															<UpdatedControls>
															    <telerik:AjaxUpdatedControl ControlID="txtID"></telerik:AjaxUpdatedControl>
																<telerik:AjaxUpdatedControl ControlID="chkIsBonus"></telerik:AjaxUpdatedControl>
																<telerik:AjaxUpdatedControl ControlID="RadComboBoxItemSeqNo"></telerik:AjaxUpdatedControl>
																...
																<telerik:AjaxUpdatedControl ControlID="txtDPAmt"></telerik:AjaxUpdatedControl>
																<telerik:AjaxUpdatedControl ControlID="txtGrandTotal"></telerik:AjaxUpdatedControl>																
																<telerik:AjaxUpdatedControl ControlID="RadGridDeliveryOrder" LoadingPanelID="AjaxLoadingPanel1"></telerik:AjaxUpdatedControl>
															</UpdatedControls>
														</telerik:AjaxSetting>
                                                    ...
                                                    <tr>
                                                        <td valign="top" width="33%">
                                                            <table cellspacing="1" cellpadding="2" width="100%">
                                                                <tr>
                                                                    <td width="30%">
                                                                        <asp:Label ID="lblDeliveryOrderID" runat="server" Text="Delivery Order No."></asp:Label>
                                                                    </td>
                                                                    <td width="70%">
                                                                        <telerik:RadComboBox ID="RadComboBoxDeliveryOrderID" ShowMoreResultBox="false" AutoPostBack="true"
                                                                            ...
                                                                            Height="200px" runat="server" Skin="WebBlue" MaxLength="15" DataTextField="DONO"
                                                                                ...
                                                                                <table style="width: 500px; text-align: left; font-family: tahoma,arial;" cellpadding="1"
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td style="width: 100px;">
                                                                                            <%# format(DataBinder.Eval(Container.DataItem, "DODate"),"dd-MM-yyyy") %>
                                                                                        </td>
                                                                ...
                                                                <tr>
                                                                    <td width="30%">
                                                                        <asp:Label ID="lblDODateCaption" runat="server" Text="Date"></asp:Label>
                                                                    </td>
                                                                    <td width="70%">
                                                                        <telerik:RadDatePicker ID="RadDODate" runat="server" MinDate="2006-01-01" SharedCalendarID="sharedCalendar"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="70%">
                                                                        <asp:TextBox ID="txtCurrencyRate" runat="server" MaxLength="16" ReadOnly="True" AutoPostBack="True"
                                                        ...
                                                        <td valign="top" width="33%">
                                                            <table cellspacing="1" cellpadding="2" width="100%">
                                                                ...
                                                                <tr>
                                                                    <td width="30%">
                                                                        <asp:Label ID="lblPrimaryPhoneCaption" runat="server" Text="Primary Phone No."></asp:Label>
                                                                    </td>
                                                                    <td width="70%">
                                                                        <asp:TextBox ID="txtPrimaryPhoneNo" runat="server" Width="70%" MaxLength="500"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td width="30%">
                                                                        <asp:Label ID="lblDeliveryAddressCaption" runat="server" Text="Delivery Address"></asp:Label>
                                                                    </td>
                                                                    <td width="70%">
                                                                        <asp:TextBox ID="txtDeliveryAddress" runat="server" Width="70%" MaxLength="500" TextMode="MultiLine"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="70%">
                                                                        <asp:DropDownList ID="ddlDeliveryZone" runat="Server" Width="70%" AutoPostBack="True">
                                                                        </asp:DropDownList>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td width="30%">
                                                                        <asp:Label ID="lblMinPurchaseAmountCaption" runat="server" Text="Min. Purchase Amt"></asp:Label>
                                                                    </td>
                                                                    <td width="70%">
                                                                        <asp:TextBox ID="txtMinPurchaseAmount" runat="server" MaxLength="16" ReadOnly="True"
                                                                            Style="text-align: right" Width="70%"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td width="30%">
                                                                        <asp:Label ID="lblMinPurchaseQtyCaption" runat="server" Text="Min. Purchase Qty"></asp:Label>
                                                                    </td>
                                                                    <td width="70%">
                                                                        <asp:TextBox ID="txtMinPurchaseQty" runat="server" MaxLength="16" ReadOnly="True"
                                                                            Style="text-align: right" Width="70%"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="70%">
                                                                        <asp:TextBox ID="txtDescriptionHd" runat="server" MaxLength="500" Width="70%" TextMode="MultiLine"
                                                                            Height="140px" Style="font-size: 9pt; font-family: Tahoma"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="60%">
                                                                        <asp:TextBox ID="txtDescriptiondt" runat="server" MaxLength="500" Width="70%" TextMode="MultiLine"
                                                                            Style="font-size: 9pt; font-family: Tahoma"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
