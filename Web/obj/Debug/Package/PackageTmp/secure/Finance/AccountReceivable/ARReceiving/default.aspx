...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="default.aspx.vb" Inherits="Raven.Web.Secure.Finance.AccountReceivable.ARReceiving"
    EnableSessionState="true" EnableViewState="true" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>A/R Receiving</title>
                                                        ...
                                                        <tr>
                                                            <td valign="top" width="33%">
                                                                <table cellspacing="1" cellpadding="2" width="100%">
                                                                    <tr>
                                                                        <td width="30%">
                                                                            <asp:Label ID="lblARReceivingID" runat="server" Text="A/R Receiving No."></asp:Label>
                                                                        </td>
                                                                        <td width="70%">
                                                                            <telerik:RadComboBox ID="RadComboBoxARReceivingID" ShowMoreResultBox="False" AutoPostBack="true"
                                                                                ...
                                                                                Height="200px" runat="server" Skin="WebBlue" MaxLength="15" DataTextField="ARReceivingNo"
                                                                                DataValueField="ARReceivingNo" ShowDropDownOnTextboxClick="True">
                                                                                <ItemTemplate>
                                                                                    <table style="width: 500px; text-align: left; font-family: tahoma,arial;" cellpadding="1"
                                                                                        cellspacing="0">
                                                                                        <tr>
                                                                                            <td style="width: 120px;">
                                                                                                <%# DataBinder.Eval(Container.DataItem, "ARReceivingNo") %>
                                                                                            </td>
                                                                                            <td style="width: 100px;">
                                                                                                <%# format(DataBinder.Eval(Container.DataItem, "ARReceivingDate"),"dd-MM-yyyy") %>
                                                                                            </td>
                                                                    ...
                                                                    <tr>
                                                                        <td width="30%">
                                                                            <asp:Label ID="lblARReceivingDateCaption" runat="server" Text="Date"></asp:Label>
                                                                        </td>
                                                                        <td width="70%">
                                                                            <telerik:RadDatePicker ID="RadARReceivingDate" runat="server" MinDate="2006-01-01"
                                                            ...
                                                            <td valign="top" width="33%">
                                                                <table cellspacing="1" cellpadding="2" width="100%">
                                                                    ...
                                                                    <tr>
                                                                        <td width="30%">
                                                                            <asp:Label ID="lblARReceivingTypeIDCaption" runat="server" Text="AR Receiving Type"></asp:Label>
                                                                        </td>
                                                                        <td width="70%">
                                                                            <asp:DropDownList ID="ddlARReceivingTypeID" runat="Server" AutoPostBack="True" Width="70%"
                                                                                Enabled="True">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                            ...
                                                            <td valign="top" width="100%" colspan="2">
                                                                <asp:DataGrid ID="RadGridARInvoicing" runat="server" Style="width: 100%" CellPadding="1"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateColumn runat="server" HeaderText="Invoice Date">
                                                                            <ItemTemplate>
                                                                                <asp:Label runat="server" Style="margin-left: 0; margin-right: 5; display: none;"
                                                                                    ID="_lblSalesInvoiceDate" Text='<%# DataBinder.Eval(Container.DataItem, "SalesInvoiceDate") %>' />
                                                                                <asp:Label runat="server" Style="margin-left: 0; margin-right: 5; display: none;"
                                                                                    ID="_lblSalesInvoiceDateFormated" Text='<%# Format(DataBinder.Eval(Container.DataItem, "SalesInvoiceDate"), "dd-MM-yyyy") %>' />
                                                                            </ItemTemplate>
                                                                        </asp:TemplateColumn>
                                                                        <asp:TemplateColumn runat="server" HeaderText="Currency Rate">
                                                                            <ItemTemplate>
                                                                        ...
                                                                        <asp:TemplateColumn runat="server" HeaderText="n Payment">
                                                                            <ItemTemplate>
                                                                                <asp:Label runat="server" ID="_lblnARReceiving" Text='<%# DataBinder.Eval(Container.DataItem, "nARReceiving") %>' />
                                                                            </ItemTemplate>
                                                                        </asp:TemplateColumn>
                                                                        <asp:TemplateColumn runat="server" HeaderText="Total">
                                                                            <ItemTemplate>
                                                                        ...
                                                                        <asp:TemplateColumn runat="server" HeaderText="Balance Due" ItemStyle-HorizontalAlign="Right"
                                                                            HeaderStyle-HorizontalAlign="Right">
                                                                            <ItemTemplate>
                                                                                <asp:Label runat="server" ID="_lblbalancedue" Text='<%# format(DataBinder.Eval(Container.DataItem, "Total") - DataBinder.Eval(Container.DataItem, "PaidAmount"),"#,##0.00") %>' />
                                                                            </ItemTemplate>
                                                                        </asp:TemplateColumn>
                                                                        <asp:TemplateColumn runat="server" HeaderText="Payment" ItemStyle-HorizontalAlign="Right"
                                                                            HeaderStyle-HorizontalAlign="Right">
                                                                            <ItemTemplate>
                                                                                <asp:TextBox ID="_txtpayment" AutoPostBack="False" runat="server" Text='<%# format(DataBinder.Eval(Container.DataItem, "Total") - DataBinder.Eval(Container.DataItem, "PaidAmount"),"#,##0.00")  %>'
                                        ...
                                        <td valign="top" width="100%" colspan="2">
                                            <div style="overflow: auto; width: 100%; height: 100%" id="RLDivP">
                                                <table cellspacing="0" cellpadding="0" width="100%">
                                                    <tr>
                                                        <td valign="top" width="100%" colspan="2">
                                                            <asp:DataGrid ID="RadGridARReceiving" runat="server" Style="width: 100%" CellPadding="1"
                                                                ShowFooter="False" PageSize="20" AllowPaging="false" GridLines="None" BorderWidth="1"
                                                                BorderColor="Gainsboro" CellSpacing="1" AutoGenerateColumns="False" AllowSorting="True">
                                                                <HeaderStyle CssClass="gridheaderstyle" />
                                                                <AlternatingItemStyle CssClass="gridAlternatingItemstyle" />
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateColumn runat="server" HeaderText="Receiving No.">
                                                                        <ItemTemplate>
                                                                            <asp:Label runat="server" ID="_lblARReceivingNo" Text='<%# DataBinder.Eval(Container.DataItem, "ARReceivingNo") %>' />
                                                                        </ItemTemplate>
                                                                    </asp:TemplateColumn>
                                                                    <asp:TemplateColumn runat="server" HeaderText="Invoice No.">
                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateColumn runat="server" HeaderText="n Payment">
                                                                        <ItemTemplate>
                                                                            <asp:Label runat="server" ID="_lblnARReceivingP" Text='<%# DataBinder.Eval(Container.DataItem, "nARReceiving") %>' />
                                                                        </ItemTemplate>
                                                                    </asp:TemplateColumn>
