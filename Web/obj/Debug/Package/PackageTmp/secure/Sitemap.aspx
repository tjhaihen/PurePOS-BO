...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Sitemap.aspx.vb" Inherits="Raven.Web.Sitemap" %>
				...
				<tr>
					<td vAlign="top" width="80%">
						<table border="0" cellSpacing="1" cellPadding="3" width="100%" bgColor="gray" height="100%">
							...
							<tr>
								<td class="rheadercol" vAlign="middle" width="100%" align="left">Sitemap
								</td>
										...
										<table width="100%" height="100%">
											<tr>
												<td width="100%" height="100%" valign="top">
													<telerik:RadTreeView ID="RadTreeViewSitemap" Runat="server"  
																		width="100%" height="100%" AutoPostBack="False"></telerik:RadTreeView>
												</td>																								
											</tr>																					
										</table>
									</div>
