...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="default.aspx.vb" Inherits="Raven.Web.Secure.Transaction.SalesReturn"
                                    ...
                                    <td valign="top" width="100%">
                                        ...
                                        <%--<telerik:RadAjaxManager id="RadAjaxManager1" runat="server"  EnableOutsideScripts="True">
													<AjaxSettings>
														...
														<telerik:AjaxSetting AjaxControlID="RadGridSalesReturn">
															<UpdatedControls>
															<telerik:AjaxUpdatedControl ControlID="txtID"></telerik:AjaxUpdatedControl>
																<telerik:AjaxUpdatedControl ControlID="chkIsBonus"></telerik:AjaxUpdatedControl>
																<telerik:AjaxUpdatedControl ControlID="RadComboBoxItemSeqNo"></telerik:AjaxUpdatedControl>
																...
																<telerik:AjaxUpdatedControl ControlID="txtPPN"></telerik:AjaxUpdatedControl>		
																<telerik:AjaxUpdatedControl ControlID="txtGrandTotal"></telerik:AjaxUpdatedControl>
																<telerik:AjaxUpdatedControl ControlID="RadGridSalesUnit"></telerik:AjaxUpdatedControl>
																<telerik:AjaxUpdatedControl ControlID="RadGridSalesReturn" LoadingPanelID="AjaxLoadingPanel1"></telerik:AjaxUpdatedControl>
															</UpdatedControls>
														</telerik:AjaxSetting>
                                    ...
                                    <asp:Panel ID="PanelHeader" runat="server">
                                                        ...
                                                        <tr>
                                                            <td valign="top" width="33%">
                                                                <table cellspacing="1" cellpadding="2" width="100%">
                                                                    <tr>
                                                                        <td width="30%">
                                                                            <asp:Label ID="lblSalesReturnNoCaption" runat="server" Text="Sales Return No."></asp:Label>
                                                                        </td>
                                                                        <td width="70%">
                                                                            <telerik:RadComboBox ID="RadComboBoxSalesReturnID" ShowMoreResultBox="false" AutoPostBack="true"
                                                                                ...
                                                                                Height="200px" runat="server" Skin="WebBlue" MaxLength="15" DataTextField="SReturnNo"
                                                                                DataValueField="SReturnNo" ShowDropDownOnTextboxClick="False">
                                                                                <ItemTemplate>
                                                                                    <table style="width: 500px; text-align: left; font-family: tahoma,arial;" cellpadding="1"
                                                                                        cellspacing="0">
                                                                                        <tr>
                                                                                            <td style="width: 120px;">
                                                                                                <%# DataBinder.Eval(Container.DataItem, "SReturnNo") %>
                                                                                            </td>
                                                                                            <td style="width: 100px;">
                                                                                                <%# format(DataBinder.Eval(Container.DataItem, "SReturnDate"),"dd-MM-yyyy") %>
                                                                                            </td>
                                                                    ...
                                                                    <tr>
                                                                        <td width="30%">
                                                                            <asp:Label ID="lblSReturnDateCaption" runat="server" Text="Date"></asp:Label>
                                                                        </td>
                                                                        <td width="70%">
                                                                            <telerik:RadDatePicker ID="RadSReturnDate" runat="server" MinDate="2006-01-01" SharedCalendarID="sharedCalendar"
                                                                    ...
                                                                    <tr>
                                                                        <td width="30%">
                                                                            <asp:Label ID="lblSTxnNo" runat="server" Text="Sales Unit No."></asp:Label>
                                                                        </td>
                                                                        <td width="70%">
                                                                            <telerik:RadComboBox ID="RadComboBoxSTxnNo" ShowMoreResultBox="false" AutoPostBack="true"
                                                                                AllowCustomText="True" Width="70%" ItemRequestTimeout="200" DropDownWidth="500px"
                                                                                HighlightTemplatedItems="true" EnableLoadOnDemand="true" MarkFirstMatch="true"
                                                                    ...
                                                                    <tr>
                                                                        <td width="30%">
                                                                            <asp:Label ID="lblSTxnDateCaption" runat="server" Text="Sales Unit Date"></asp:Label>
                                                                        </td>
                                                                        <td width="70%">
                                                                            <telerik:RadDatePicker ID="RadSUnitDate" runat="server" MinDate="2006-01-01" SharedCalendarID="sharedCalendar"
                                                                                Culture="Marathi (India)" Enabled="False">
                                                                                <DateInput Width="40%" Font-Size="XSmall" Enabled="False">
                                                                                </DateInput>
                                                                                <DatePopupButton HoverImageUrl="/pureravenslib/images/datepicker_popuphover.gif"
                                                                                    ImageUrl="/pureravenslib/images/datepicker_popup.gif" Visible="False"></DatePopupButton>
                                                                            </telerik:RadDatePicker>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            ...
                                                            <td valign="top" width="33%">
                                                                <table cellspacing="1" cellpadding="2" width="100%">
                                                                    <tr>
                                                                        <td width="30%">
                                                                            <asp:Label ID="lblSReturnReasonCaption" runat="server" Text="Reason"></asp:Label>
                                                                        </td>
                                                                        <td width="70%">
                                                                            <asp:DropDownList ID="ddlSReturnReason" runat="Server" Width="70%" Enabled="True">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td width="70%">
                                                                            <asp:DropDownList ID="ddlCurrency" runat="Server" Width="70%" Enabled="True">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                        ...
                                        <asp:Panel ID="PanelGridDO" runat="server">
                                            <tr>
                                                ...
                                                <td class="rheader" height="25" valign="middle" width="98%" align="left">
                                                    &nbsp;
                                                    <asp:Label ID="lblRecordSUCaption" runat="server" Text="Sales Unit List"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td valign="top" width="100%" colspan="2">
                                                                ...
                                                                <td valign="top" align="left" colspan="3" width="100%">
                                                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" class="my_toolbarbutton_horizontal">
                                                                        <tr>
                                                                            ...
                                                                            <td valign="middle">
                                                                                <asp:LinkButton runat="server" ID="lbtnSaveGetItemSU" class="my_toolbarbutton" Text="Save List"
                                                                    ...
                                                                    <asp:DataGrid ID="RadGridSalesUnit" runat="server" Style="width: 100%" CellPadding="1"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateColumn runat="server" HeaderText="Qty Remaining" ItemStyle-HorizontalAlign="Right"
                                                                                HeaderStyle-HorizontalAlign="Right">
                                                                                <ItemTemplate>
                                                                                    <asp:Label runat="server" ID="_lblQtyRemaining" Text='<%# Format(DataBinder.Eval(Container.DataItem, "Qty") - DataBinder.Eval(Container.DataItem, "QtyReturn") - DataBinder.Eval(Container.DataItem, "QtySURT"), "#,##0.000") %>' />
                                                                                </ItemTemplate>
                                                                            </asp:TemplateColumn>
                                                                            <asp:TemplateColumn runat="server" HeaderText="Qty Return" ItemStyle-HorizontalAlign="Right"
                                                                                HeaderStyle-HorizontalAlign="Right">
                                                                                <ItemTemplate>
                                                                                    <asp:TextBox ID="_txtQtyReturn" AutoPostBack="False" Width="75px" runat="server"
                                                                                        Text="0.000" Style="text-align: right" onblur="FormatCurrency(this);" />
                                                                                </ItemTemplate>
                                                                            </asp:TemplateColumn>
                                                                            ...
                                                                            <asp:TemplateColumn runat="server" HeaderText="Item Factor" ItemStyle-HorizontalAlign="Right"
                                                                                HeaderStyle-HorizontalAlign="Right">
                                                                                <ItemTemplate>
                                                                                    <asp:Label ID="_lblItemFactor" autopostback="False" runat="server" Text='<%# format(DataBinder.Eval(Container.DataItem, "ItemFactor"), "#,##0.000") %>'
                                                                            ...
                                                                            <asp:TemplateColumn runat="server" HeaderText="Unit Price" ItemStyle-HorizontalAlign="Right"
                                                                                HeaderStyle-HorizontalAlign="Right">
                                                                                <ItemTemplate>
                                                                                    <asp:TextBox ID="_TxtPrice" AutoPostBack="False" runat="server" Text='<%# format(DataBinder.Eval(Container.DataItem, "Price"),"#,##0.00") %>'
                                                                            ...
                                                                            <asp:TemplateColumn runat="server" HeaderText="Return Fee ( % )" ItemStyle-HorizontalAlign="Right"
                                                                                HeaderStyle-HorizontalAlign="Right">
                                                                                <ItemTemplate>
                                                                                    <asp:TextBox ID="_TxtReturnFeePct" AutoPostBack="False" runat="server" Text="0.00"
                                                                                        Style="text-align: right" onblur="FormatCurrency(this);" />
                                                                                </ItemTemplate>
                                                                            </asp:TemplateColumn>
                                                            ...
                                                            <td valign="top" width="33%">
                                                                <table cellspacing="1" cellpadding="2" width="100%">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="70%">
                                                                            <asp:DropDownList ID="ddlItemUnitID" runat="Server" Width="70%" Enabled="False" AutoPostBack="True">
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                            ...
                                                            <td valign="top" width="33%">
                                                                <table cellspacing="1" cellpadding="2" width="100%">
                                                                    <tr>
                                                                        ...
                                                                        <td width="70%">
                                                                            <asp:TextBox ID="txtPrice" runat="server" onblur="FormatCurrency(this);" ReadOnly="True"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="70%">
                                                                            <asp:TextBox ID="txtDisc1Pct" runat="server" AutoPostBack="true" ReadOnly="True"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="70%">
                                                                            <asp:TextBox ID="txtDisc1Amt" runat="server" onblur="FormatCurrency(this);" ReadOnly="True"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="70%">
                                                                            <asp:TextBox ID="txtDisc2Pct" runat="server" onblur="FormatCurrency(this);" ReadOnly="True"
                                                                                AutoPostBack="true" MaxLength="16" Style="text-align: right" Width="70%"></asp:TextBox>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td width="70%">
                                                                            <asp:TextBox ID="txtDisc2Amt" runat="server" onblur="FormatCurrency(this);" ReadOnly="True"
                                                                                AutoPostBack="true" MaxLength="16" Style="text-align: right" Width="70%"></asp:TextBox>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            ...
                                                            <td valign="top" width="33%">
                                                                <table cellspacing="1" cellpadding="2" width="100%">
                                                                    <tr>
                                                                        ...
                                                                        <td width="70%">
                                                                            <asp:TextBox ID="txtDisc3Amt" runat="server" onblur="FormatCurrency(this);" ReadOnly="True"
                                                                                AutoPostBack="true" MaxLength="16" Style="text-align: right" Width="70%"></asp:TextBox>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td width="70%">
                                                                            <asp:TextBox ID="txtDisc3Pct" runat="server" onblur="FormatCurrency(this);" ReadOnly="True"
                                                                                AutoPostBack="true" MaxLength="16" Style="text-align: right" Width="70%"></asp:TextBox>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="70%">
                                                                            <asp:TextBox ID="txtDescriptiondt" runat="server" MaxLength="500" Width="70%" Style="font-size: 9pt;
                                            ...
                                            <td valign="top" width="100%" colspan="2">
                                                <div style="overflow: auto; width: 100%; height: 300px" id="RLDiv">
                                                    <table cellspacing="0" cellpadding="0" width="100%">
                                                        <tr>
                                                            <td valign="top" width="100%" colspan="2">
                                                                <asp:DataGrid ID="RadGridSalesReturn" runat="server" Style="width: 100%" CellPadding="1"
                                                                    ShowFooter="False" PageSize="20" AllowPaging="false" GridLines="None" BorderWidth="1"
                                                                    BorderColor="Gainsboro" CellSpacing="1" AutoGenerateColumns="False" AllowSorting="True">
                                                                    <HeaderStyle CssClass="gridheaderstyle" />
                                                                    <AlternatingItemStyle CssClass="gridAlternatingItemstyle" />
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateColumn runat="server" Visible="false" HeaderText="Return Fee ( % )"
                                                                            ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right">
                                                                            <ItemTemplate>
                                                                                <asp:Label runat="server" ID="_lblReturnFeePct" Text='<%# DataBinder.Eval(Container.DataItem, "ReturnFeePct") %>' />
                                                                            </ItemTemplate>
                                                                        </asp:TemplateColumn>
                                                                        <asp:TemplateColumn runat="server" HeaderText="Return Fee" ItemStyle-HorizontalAlign="Right"
                                                                            HeaderStyle-HorizontalAlign="Right">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="right" width="20%">
                                                                <asp:Label ID="lblReturnFeeAmtCaption" runat="server" Text="Return Fee"></asp:Label>
                                                                &nbsp;&nbsp;
