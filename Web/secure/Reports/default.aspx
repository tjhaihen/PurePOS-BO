                                                                    ...
                                                                    <td valign="top">
                                                                        ...
                                                                        <asp:Panel ID="pnlCustomer" runat="server" Visible="False">
                                                                            <table width="100%">
                                                                                ...
                                                                                <tr>
                                                                                    <td width="120px" valign="top">
                                                                                        <asp:Label ID="lblCustomer" runat="server" Text="Customer ID" />
                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtCustomerID" runat="server" MaxLength="15" AutoPostBack="True"
                                                                                            Width="174px" />
                                                                                        <input type="Button" class="sbttn" value="..." style="width: 22px; height: 22px;"
                                                                                            onclick="javascript:NewWindow('<%= UrlBase + "/incl/SearchList.aspx?" %>cd=200&txt=txtCustomerID&default=CustomerName','_SearchList',700,460,'no','yes')">
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </asp:Panel>
