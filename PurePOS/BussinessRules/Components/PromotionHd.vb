...
#Region " Class Member Declarations "
        Private _ID, _PromotionName, _PromotionTypeID, _MemberTypeID, _Description As String
        ...
        Private _IsNoEndDate, _IsMultipleApplied, _IsActive As Boolean
#End Region
        ...
        Public Overrides Function Insert() As Boolean
            ...
            cmdToExecute.CommandText = "INSERT INTO PromotionHd " & _
                                        "(ID, PromotionName, StartDate, EndDate, IsNoEndDate, PromotionTypeID, SpecialPrice, BuyQty, GetQty, " & _
                                        " Disc1Pct, Disc2Pct, BuyAmt, IsMultipleApplied, GetVoucherAmt, nPurchase, MemberTypeID, " & _
                                        " UserInsert, InsertDate, UserUpdate, UpdateDate, isActive, Description) " & _
                                        "VALUES (@ID, @PromotionName, @StartDate, @EndDate, @IsNoEndDate, @PromotionTypeID, @SpecialPrice, @BuyQty, @GetQty, " & _
                                        " @Disc1Pct, @Disc2Pct, @BuyAmt, @IsMultipleApplied, @GetVoucherAmt, @nPurchase, @MemberTypeID, " & _
                                        " @UserInsert, getdate(), @UserUpdate, getdate(), @isActive, left(@Description,500))"
            ...
            Try
                ...
                cmdToExecute.Parameters.Add("@IsNoEndDate", _IsNoEndDate)
        ...
        Public Overrides Function SelectOne(Optional ByVal recStatus As RavenRecStatus = RavenRecStatus.CurrentRecord) As DataTable
            ...
            Try
                ...
                If toReturn.Rows.Count > 0 Then
                    ...
                    _IsNoEndDate = CType(toReturn.Rows(0)("IsNoEndDate"), Boolean)
...
#Region " Class Property Declarations "
        ...
        Public Property [IsNoEndDate]() As Boolean
            Get
                Return _IsNoEndDate
            End Get
