...
#End Region
        ...
        Public Overrides Function Insert() As Boolean
            ...
            cmdToExecute.CommandText = "INSERT INTO ItemUnit " & _
                                        "(ItemUnitID, ItemUnitName, Description, IsAllowDecimal, isActive, UserInsert, InsertDate, UserUpdate, UpdateDate) " & _
                                        "VALUES (@ItemUnitID, @ItemUnitName, left(@Description,500), @IsAllowDecimal, @IsActive, @UserInsert, GetDate(), @UserUpdate, GetDate())"
            ...
            Try
                ...
                cmdToExecute.Parameters.Add("@IsAllowDecimal", _IsAllowDecimal)
        ...
        Public Overrides Function Update() As Boolean
            ...
            cmdToExecute.CommandText = "UPDATE ItemUnit " & _
                                        ...
                                        "IsAllowDecimal = @IsAllowDecimal, " & _
...
#Region " Custom Functions "
        Public Function SelectAllActive() As DataTable
            ...
            cmdToExecute.CommandText = "SELECT * FROM ItemUnit WHERE isActive = 1 ORDER BY ItemUnitID ASC"
            cmdToExecute.CommandType = CommandType.Text
        ...
        Public Function SelectAllByItemSeqNo(ByVal ItemSeqNo As String) As DataTable
            ...
            cmdToExecute.CommandText = "SELECT DISTINCT ift.ItemSeqNo,iu.ItemUnitID,iu.ItemUnitName " + _
                                       "FROM ItemUnit iu " + _
        ...
        Public Function SelectAllByItemSeqNoForDOandSU(ByVal ItemSeqNo As String) As DataTable
            Dim cmdToExecute As SqlCommand = New SqlCommand

            cmdToExecute.CommandText = "SELECT DISTINCT ift.ItemSeqNo,iu.ItemUnitID,iu.ItemUnitName " + _
                                       "FROM ItemUnit iu " + _
                                       "INNER JOIN ItemFactorTemplate ift ON ift.ItemUnitID = iu.ItemUnitID AND iu.IsActive = 1 " + _
                                       "WHERE ift.ItemSeqNo = @ItemSeqNo and iu.ItemUnitID <> (SELECT i.ItemMUnitID FROM Item i WHERE i.IsActive = 1 AND i.ItemSeqNo = ift.ItemSeqNo)"
            cmdToExecute.CommandType = CommandType.Text
