...
#End Region
        ...
        Public Overrides Function Insert() As Boolean
            ...
            cmdToExecute.CommandText = "INSERT INTO Branch " & _
                                        ...
                                        "VALUES (@BranchID, @BranchName, @Address, @ZipCode, @PhoneCodeArea, @PhoneNo,  left(@Description,500), @IsActive, @UserInsert, GetDate(), @UserUpdate, GetDate())"
        ...
        Public Overrides Function SelectAll() As DataTable
            ...
            cmdToExecute.CommandText = "SELECT * FROM Branch order by BranchId"
            cmdToExecute.CommandType = CommandType.Text
