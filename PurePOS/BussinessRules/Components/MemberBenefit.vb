...
#End Region
        ...
        Public Overrides Function Insert() As Boolean
            ...
            cmdToExecute.CommandText = "INSERT INTO MemberBenefit " & _
                                        ...
                                        "VALUES (@MBTypeID, @MBTypeName, left(@Description,500), @IsActive, @UserInsert, GetDate(), @UserUpdate, GetDate())"
        ...
        Public Function SelectAllActive() As DataTable
            ...
            cmdToExecute.CommandText = "SELECT * FROM MemberBenefit WHERE IsActive = 1 ORDER BY MBtypeID"
            cmdToExecute.CommandType = CommandType.Text
        ...
        Public Overrides Function SelectOne(Optional ByVal recStatus As RavenRecStatus = RavenRecStatus.CurrentRecord) As DataTable
            ...
            Select Case recStatus
                Case RavenRecStatus.CurrentRecord
                    cmdToExecute.CommandText = "SELECT * FROM MemberBenefit WHERE MBTypeID = @MBTypeID"
                Case RavenRecStatus.NextRecord
                    cmdToExecute.CommandText = "SELECT * FROM MemberBenefit WHERE MBTypeID > @MBTypeID ORDER BY MBTypeID ASC"
                Case RavenRecStatus.PreviousRecord
                    cmdToExecute.CommandText = "SELECT * FROM MemberBenefit WHERE MBTypeID < @MBTypeID ORDER BY MBTypeID DESC"
            End Select
            cmdToExecute.CommandType = CommandType.Text
            Dim toReturn As DataTable = New DataTable("MemberBenefit")
            Dim adapter As SqlDataAdapter = New SqlDataAdapter(cmdToExecute)
