...
#End Region
        ...
        Public Overrides Function Insert() As Boolean
            ...
            cmdToExecute.CommandText = "INSERT INTO BankAccount " & _
                                        ...
                                        "VALUES (@BankID, @BankTxnType,@BankName, @Branch, @AccountNo, @AccountTitle, @Address, @Currency, left(@Description,500), @IsActive, @UserInsert, GetDate(), @UserUpdate, GetDate())"
        ...
        Public Overrides Function SelectAll() As DataTable
            ...
            cmdToExecute.CommandText = "SELECT b.*,isnull(cs.DetailDesc,'') as BankTxnTypeName,isnull(cs1.DetailDesc,'') as CurrencyName FROM BankAccount b " & _
                                       ...
                                       "left join CommonSetting cs1 on cs1.GroupID = 'Currency' and cs1.DetailID = b.Currency where b.IsActive = 1 order by b.BankId"
            cmdToExecute.CommandType = CommandType.Text
