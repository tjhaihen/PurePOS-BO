...
#End Region
        ...
        Public Overrides Function Insert() As Boolean
            ...
            cmdToExecute.CommandText = "INSERT INTO MarginRangeHd " & _
                                        ...
                                        "VALUES (@MarginRangeID, @MarginRangeName,  left(@Description,500), @UserInsert, getdate(), @UserUpdate, getdate(), @IsActive)"
...
#Region " Custom Functions "
        Public Function SelectAllActive() As DataTable
            ...
            cmdToExecute.CommandText = "SELECT * FROM MarginRangeHd WHERE isActive = 1 ORDER BY MarginRangeID"
            cmdToExecute.CommandType = CommandType.Text
