...
#End Region
        ...
        Public Overrides Function Update() As Boolean
            ...
            cmdToExecute.CommandText = "UPDATE ItemFactorTemplate " & _
                                        ...
                                        "WHERE ItemSeqNo = @ItemSeqNo and ItemUnitID = @ItemUnitID and ItemFactor = @ItemFactor "
            cmdToExecute.CommandType = CommandType.Text
        ...
        Public Overrides Function SelectOne(Optional ByVal recStatus As RavenRecStatus = RavenRecStatus.CurrentRecord) As DataTable
            ...
            Select Case recStatus
                Case RavenRecStatus.CurrentRecord
                    cmdToExecute.CommandText = "SELECT TOP 1 * FROM ItemFactorTemplate WHERE ItemSeqNo = @ItemSeqNo and ItemUnitID = @ItemUnitID"
                Case RavenRecStatus.NextRecord
                    cmdToExecute.CommandText = "SELECT TOP 1 * FROM ItemFactorTemplate WHERE ItemSeqNo = @ItemSeqNo or ItemUnitID > @ItemUnitID ORDER BY ItemSeqNo, ItemUnitID ASC"
                Case RavenRecStatus.PreviousRecord
                    cmdToExecute.CommandText = "SELECT TOP 1 * FROM ItemFactorTemplate WHERE ItemSeqNo = @ItemSeqNo or ItemUnitID < @ItemUnitID ORDER BY ItemSeqNo, ItemUnitID DESC"
            End Select
            cmdToExecute.CommandType = CommandType.Text
            Dim toReturn As DataTable = New DataTable("ItemUnit")
            Dim adapter As SqlDataAdapter = New SqlDataAdapter(cmdToExecute)
        ...
        Public Function SelectOneByPrimary() As DataTable
            Dim cmdToExecute As SqlCommand = New SqlCommand
            cmdToExecute.CommandText = "SELECT * FROM ItemFactorTemplate WHERE ItemSeqNo = @ItemSeqNo AND ItemUnitID = @ItemUnitID AND ItemFactor = @ItemFactor"
            cmdToExecute.CommandType = CommandType.Text
            Dim toReturn As DataTable = New DataTable("ItemUnit")
            Dim adapter As SqlDataAdapter = New SqlDataAdapter(cmdToExecute)
        ...
        Public Function SelectByItemSeqNo() As DataTable
            Dim cmdToExecute As SqlCommand = New SqlCommand
            cmdToExecute.CommandText = "SELECT * FROM ItemFactorTemplate WHERE ItemSeqNo = @ItemSeqNo ORDER BY ItemUnitID"
            cmdToExecute.CommandType = CommandType.Text
