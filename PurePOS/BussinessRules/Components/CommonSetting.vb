...
#End Region
        ...
        Public Overrides Function Insert() As Boolean
            ...
            cmdToExecute.CommandText = "INSERT INTO CommonSetting " & _
                                        ...
                                        "(@ID, @GroupID, @DetailID, @DetailDesc, left(@Description,500), " & _
            ...
            Try
                ...
                cmdToExecute.Parameters.Add("@IsSystem", _IsSystem)
        ...
        Public Overrides Function SelectAll() As DataTable
            ...
            cmdToExecute.CommandText = "SELECT * FROM CommonSetting where isDeleted = 0 order by GroupID, ID"
            cmdToExecute.CommandType = CommandType.Text
        ...
        Public Function SelectAllByGroupID(Optional ByVal IsActiveOnly As Boolean = False) As DataTable
            Dim cmdToExecute As SqlCommand = New SqlCommand
            If IsActiveOnly = False Then
                cmdToExecute.CommandText = "SELECT * FROM CommonSetting " + " where GroupID = @GroupID and isDeleted = 0 order by DetailID "
            Else
