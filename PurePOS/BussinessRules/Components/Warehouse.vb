...
#End Region
        ...
        Public Overrides Function Insert() As Boolean
            ...
            cmdToExecute.CommandText = "INSERT INTO Warehouse " & _
                                        ...
                                        "VALUES (@WhID, @WhName, @UnitID, @UnitName, left(@Description,500), @IsActive, @UserInsert, GetDate(), @UserUpdate, GetDate())"
...
#Region " Custom Functions "
        Public Function SelectAllWarehouseForWHID(ByVal Filter As String, Optional ByVal MaxRecord As String = "") As DataTable
            Dim cmdToExecute As SqlCommand = New SqlCommand

            cmdToExecute.CommandText = "SELECT DISTINCT Top " + MaxRecord + " WhID, WhName FROM Warehouse " & _
                                       "WHERE isActive = 1 " & _
                                       "and (WhID LIKE '%" + Filter.Trim + "%' OR WhName LIKE '%" + Filter.Trim + "%') "
            cmdToExecute.CommandType = CommandType.Text
        ...
        Public Function SelectAllWarehouseForUnitID(ByVal Filter As String, Optional ByVal MaxRecord As String = "") As DataTable
            Dim cmdToExecute As SqlCommand = New SqlCommand

            cmdToExecute.CommandText = "SELECT DISTINCT Top " + MaxRecord + " UnitID, UnitName FROM Warehouse " & _
                                       "WHERE isActive = 1 " & _
                                       "and (UnitID LIKE '%" + Filter.Trim + "%' OR UnitName LIKE '%" + Filter.Trim + "%') "
            cmdToExecute.CommandType = CommandType.Text
        ...
        Public Function SelectOneWarehouseWithOptionalActive() As DataTable
            Dim cmdToExecute As SqlCommand = New SqlCommand

            cmdToExecute.CommandText = "SELECT DISTINCT WhID, WhName, IsActive FROM Warehouse WHERE WhID = @WhID and IsActive = @IsActive "
            cmdToExecute.CommandType = CommandType.Text
        ...
        Public Function SelectOneUnitWithOptionalActive() As DataTable
            Dim cmdToExecute As SqlCommand = New SqlCommand

            cmdToExecute.CommandText = "SELECT DISTINCT UnitID, UnitName, IsActive FROM Warehouse WHERE UnitID = @UnitID and IsActive = @IsActive "
            cmdToExecute.CommandType = CommandType.Text

            Dim toReturn As DataTable = New DataTable("Unit")
            Dim adapter As SqlDataAdapter = New SqlDataAdapter(cmdToExecute)
