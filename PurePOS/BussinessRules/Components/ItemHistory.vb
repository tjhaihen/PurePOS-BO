...
#Region "Main Function"
        ...
        Private Sub ApprovalDistribution(ByVal TxnTypeValue As String, ByVal Description As String)
            ...
            Dim strSQL_InsertHistory As New Text.StringBuilder
            Dim strSQL_InsertHistoryFO As New Text.StringBuilder
            ...
            Dim FOServerName As String = String.Empty
            Dim FODatabaseName As String = String.Empty
            ...
            With cs
                ...
                If IsUseFOServer Then
                    ...
                    .DetailID = "ServerName"
                    If .SelecOneByGroupIDByDetailID.Rows.Count > 0 Then
                        FOServerName = .DetailDesc.Trim
                    Else
                        FOServerName = String.Empty
                    End If

                    .GroupID = "FOserver"
                    .DetailID = "DBName"
                    If .SelecOneByGroupIDByDetailID.Rows.Count > 0 Then
                        FODatabaseName = .DetailDesc.Trim
                    Else
                        FODatabaseName = String.Empty
                    End If
                End If
            End With
            cs.Dispose()
            ...
            If IsUseFOServer Then
                With strSQL_InsertHistoryFO
                    .Append("Insert into " & FOServerName.Trim & FODatabaseName.Trim & ".dbo.ItemHistory" & _
                            "(ID, TxnNo, InventoryTxnID, TxnDate, WhID, UnitID, ItemSeqNo, " & _
                            "ItemLUnitID, ItemSUnitID, ItemFactor, QtySUnitBegin, QtySUnitIn, " & _
                            "QtySUnitOut, SUnitPrice, SUnitCOGS, SUnitCOGSPrev, UserInsert, " & _
                            "InsertDate, Description) " & _
            ...
            Try
                ...
                If rowsTmp.Length > 0 Then
                    ...
                    While iRecCountTmp <= rowsTmp.Length
                        ...
                        If IsUseFOServer Then
                            With New SqlCommand
                                .CommandText = strSQL_InsertHistoryFO.ToString
                                .CommandType = CommandType.Text
                                .Transaction = trans
                                .Connection = cn
