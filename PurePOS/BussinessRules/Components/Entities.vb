...
#Region " Class Member Declarations "
        ...
        Private _MemberNo, _DeliveryZoneID As String
        Private _MemberSinceDate As DateTime
...
#Region " Overrides Function(s) "
        Public Overrides Function Insert() As Boolean
            ...
            cmdToExecute.CommandText = "INSERT INTO Entities " & _
                                        ...
                                        "MaxPOrdAmount, MemberTypeID, MemberNo, MemberSinceDate, DeliveryZoneID, Description, " & _
                                        ...
                                        "@FaxNo, @Email, @Website, " & _
                                        "@Bank, @BankAccountNo, @BankBranch, @BankAddress, " & _
                                        "@MaxPOrdAmount, @MemberTypeID, @MemberNo, @MemberSinceDate, @DeliveryZoneID, left(@Description,500), " & _
            ...
            Try
                ...
                cmdToExecute.Parameters.Add("@MemberSinceDate", _MemberSinceDate)
        ...
        Public Overrides Function Update() As Boolean
            ...
            cmdToExecute.CommandText = "UPDATE Entities " & _
                                        ...
                                        "MemberNo = @MemberNo, " & _
                                        "MemberSinceDate = @MemberSinceDate, " & _
        ...
        Public Overrides Function SelectOne(Optional ByVal recStatus As RavenRecStatus = RavenRecStatus.CurrentRecord) As DataTable
            ...
            Try
                ...
                If toReturn.Rows.Count > 0 Then
                    ...
                    _MemberSinceDate = CType(toReturn.Rows(0)("MemberSinceDate"), DateTime)
...
#Region " Custom Function(s) "
        ...
        Public Function SelectByEntitiesTypeID(Optional ByVal IsActiveOnly As Boolean = False) As DataTable
            Dim cmdToExecute As SqlCommand = New SqlCommand
            ...
            Else
                cmdToExecute.CommandText = "SELECT * FROM Entities WHERE EntitiesTypeID = @EntitiesTypeID AND isActive = 1 ORDER BY EntitiesID"
            End If
            cmdToExecute.CommandType = CommandType.Text
        ...
        Public Function SelectAllForEntitiesSeqNoByEntitiesType(ByVal EntitiesTypeID As String, ByVal Filter As String, ByVal MaxRecord As String) As DataTable
            Dim cmdToExecute As SqlCommand = New SqlCommand

            cmdToExecute.CommandText = "SELECT Top " + MaxRecord.Trim + " E.*, isnull(cs.DetailDesc,'') as EntitiesTypeName FROM Entities E " & _
                                       "LEFT JOIN CommonSetting cs ON cs.GroupId = 'EntitiesType' AND cs.DetailID = E.EntitiesTypeID " & _
                                       "WHERE E.IsDeleted = 0 " & _
                                       "AND E.EntitiesTypeID = @EntitiesTypeID " & _
                                       "AND (EntitiesId LIKE '%" + Filter.Trim + "%' OR EntitiesName LIKE '%" + Filter.Trim + "%' OR EntitiesSeqNo LIKE '%" + Filter.Trim + "') " & _
                                       "ORDER BY E.EntitiesID "
            cmdToExecute.CommandType = CommandType.Text
            ...
            Try
                cmdToExecute.Parameters.Add("@EntitiesTypeID", EntitiesTypeID)
                _mainConnection.Open()
        ...
        Public Function SelectByFilterEntitiesName(ByVal strEntitiesName As String) As DataTable
            Dim cmdToExecute As SqlCommand = New SqlCommand

            cmdToExecute.CommandText = "SELECT E.*, isnull(cs.DetailDesc,'') as EntitiesTypeName FROM Entities E " & _
                                       "LEFT JOIN CommonSetting cs ON cs.GroupId = 'EntitiesType' AND cs.DetailID = E.EntitiesTypeID " & _
                                       "WHERE E.IsDeleted = 0 AND E.EntitiesName LIKE @EntitiesName " & _
                                       "ORDER BY E.EntitiesID"
            cmdToExecute.CommandType = CommandType.Text
            ...
            Try
                cmdToExecute.Parameters.Add("@EntitiesName", strEntitiesName.Trim)
                _mainConnection.Open()
        ...
        Public Function SelectOneByEntitiesIDForGlobal(Optional ByVal recStatus As RavenRecStatus = RavenRecStatus.CurrentRecord) As DataTable
            Dim cmdToExecute As SqlCommand = New SqlCommand
            cmdToExecute.CommandText = "SELECT * FROM Entities WHERE EntitiesID = @EntitiesID"
