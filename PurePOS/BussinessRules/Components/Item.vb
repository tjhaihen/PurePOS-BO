...
#Region " Class Member Declarations "
        ...
        Private _InActiveDescription As String
...
#Region " Overrides Function(s) "
        Public Overrides Function Insert() As Boolean
            ...
            cmdToExecute.CommandText = "SET XACT_ABORT ON " & _
                                        ...
                                        "IsActive, UserInsert, InsertDate, UserUpdate, UpdateDate, InActiveDescription) VALUES " & _
                                        "(@ItemSeqNo, @ItemID, @ItemName, @ItemStatusID, @PrintName, @BrandNameID, " & _
                                        "@ItemSize, @ItemCategoryID, @ItemSubCategoryID, " & _
                                        "@IsFood, @IsFresh, @IsHalal, @IsLegal, @IsImport, @IsHouseBrand, " & _
                                        "@ManufacturerID, @ProducerID, @DistributorID, @CountryID, " & _
                                        "@ItemSUnitID, @ItemMUnitID, @ItemLUnitID, " & _
                                        "@MarginRangeID, @Description, " & _
                                        "@IsActive, @UserInsert, GetDate(), @UserUpdate, GetDate(), @InActiveDescription) " & _
            ...
            Try
                ...
                'cmdToExecute.Parameters.Add("@SalesPriceBS", _SalesPriceBS)
                ...
                cmdToExecute.Parameters.Add("@InActiveDescription", _InActiveDescription)
        ...
        Public Overrides Function Update() As Boolean
            ...
            cmdToExecute.CommandText = "SET XACT_ABORT ON " & _
                                        ...
                                        "InActiveDescription = @InActiveDescription " & _
        ...
        Public Function SelectAllForItemSeqNoFormula(ByVal Filter As String, Optional ByVal MaxRecord As String = "") As DataTable
            Dim cmdToExecute As SqlCommand = New SqlCommand

            cmdToExecute.CommandText = "SELECT top " + MaxRecord.Trim + " * FROM Item I " & _
                                       "INNER JOIN ItemCategory IC on IC.ItemCategoryID = I.ItemCategoryID " & _
                                       "Where I.IsActive = 1 and IC.IsFormula = 1 and IC.IsActive = 1 " & _
                                       "and (ItemSeqNo LIKE '%" + Filter.Trim + "%' OR ItemId LIKE '%" + Filter.Trim + "%' OR ItemName LIKE '%" + Filter.Trim + "%') " & _
                                       "order by ItemId"
            cmdToExecute.CommandType = CommandType.Text
        ...
        Public Overrides Function SelectOne(Optional ByVal recStatus As RavenRecStatus = RavenRecStatus.CurrentRecord) As DataTable
            ...
            Select Case recStatus
                Case RavenRecStatus.CurrentRecord
                    cmdToExecute.CommandText = "SELECT i.*, " & _
                                                "ISNULL((SELECT TOP 1 ItemFactor FROM ItemFactorTemplate " & _
                                                "WHERE ItemSeqNo = i.ItemSeqNo AND ItemUnitID = i.ItemMUnitID ORDER BY ItemFactor DESC),0) AS ItemMUnitFactor, " & _
                                                "ISNULL((SELECT TOP 1 ItemFactor FROM ItemFactorTemplate " & _
                                                "WHERE ItemSeqNo = i.ItemSeqNo AND ItemUnitID = i.ItemLUnitID ORDER BY ItemFactor DESC),0) AS ItemLUnitFactor " & _
            ...
            Try
                ...
                If toReturn.Rows.Count > 0 Then
                    ...
                    _InActiveDescription = CType(toReturn.Rows(0)("InActiveDescription"), String)
...
#Region " Custom Function(s) "
        ...
        Public Function SelectOneByItemIDForGlobal() As DataTable
            Dim cmdToExecute As SqlCommand = New SqlCommand

            cmdToExecute.CommandText = "SELECT i.*, " & _
                                        "ISNULL((SELECT TOP 1 ItemFactor FROM ItemFactorTemplate " & _
                                        "WHERE ItemSeqNo = i.ItemSeqNo AND ItemUnitID = i.ItemMUnitID ORDER BY InsertDate ASC),0) AS ItemMUnitFactor, " & _
                                        "ISNULL((SELECT TOP 1 ItemFactor FROM ItemFactorTemplate " & _
                                        "WHERE ItemSeqNo = i.ItemSeqNo AND ItemUnitID = i.ItemLUnitID ORDER BY InsertDate ASC),0) AS ItemLUnitFactor " & _
        ...
        Public Function SelectByFilterItemName(ByVal strItemName As String, Optional ByVal isActiveOnly As Boolean = False) As DataTable
            Dim cmdToExecute As SqlCommand = New SqlCommand

            If isActiveOnly = False Then
                cmdToExecute.CommandText = "SELECT * FROM Item WHERE ItemName LIKE @ItemName"
            Else
                cmdToExecute.CommandText = "SELECT * FROM Item WHERE IsActive=1 AND ItemName LIKE @ItemName"
            End If
            cmdToExecute.CommandType = CommandType.Text
            ...
            Try
                cmdToExecute.Parameters.Add("@ItemName", strItemName.Trim)
                _mainConnection.Open()
        ...
        Public Function SelectByFilterItemNameWithROP(ByVal strWHID As String, ByVal strUnitID As String, ByVal strItemName As String, Optional ByVal isActiveOnly As Boolean = False) As DataTable
            Dim cmdToExecute As SqlCommand = New SqlCommand
            If isActiveOnly = False Then
                cmdToExecute.CommandText = "SELECT i.*, " +
                                            "ISNULL((SELECT ib.ROPMinSUnit FROM ItemROP ib WHERE ib.WHID=@WHID AND ib.UnitID=@UnitID AND ib.ItemSeqNo=i.ItemSeqNo),0) AS ROPMinSUnit, " +
                                            "ISNULL((SELECT ib.ROPMaxSUnit FROM ItemROP ib WHERE ib.WHID=@WHID AND ib.UnitID=@UnitID AND ib.ItemSeqNo=i.ItemSeqNo),0) AS ROPMaxSUnit " +
                                            "FROM Item i " +
            ...
            Else
                cmdToExecute.CommandText = "SELECT i.*, " +
                                            ...
                                            "ISNULL((SELECT ib.ROPMaxSUnit FROM ItemROP ib WHERE ib.WHID=@WHID AND ib.UnitID=@UnitID AND ib.ItemSeqNo=i.ItemSeqNo),0) AS ROPMaxSUnit " +
                                            "FROM Item i " +
                                            "WHERE i.ItemName LIKE @ItemName AND i.IsActive=1"
            End If
            cmdToExecute.CommandType = CommandType.Text
            ...
            Try
                cmdToExecute.Parameters.Add("@WHID", strWHID.Trim)
                cmdToExecute.Parameters.Add("@UnitID", strUnitID.Trim)
                cmdToExecute.Parameters.Add("@ItemName", strItemName.Trim)
                _mainConnection.Open()
...
#Region " Class Property Declarations "
        ...
        'Public Property [SalesPriceBS]() As Decimal
        '    Get
        '        Return _SalesPriceBS
        '    End Get
        '    Set(ByVal Value As Decimal)
        '        _SalesPriceBS = Value
        '    End Set
        ...
        Public Property [InActiveDescription]() As String
            Get
                Return _InActiveDescription
            End Get
            Set(ByVal Value As String)
                _InActiveDescription = Value
            End Set
        End Property
#End Region
