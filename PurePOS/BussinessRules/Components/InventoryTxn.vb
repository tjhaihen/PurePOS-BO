...
#Region " Class Member Declarations "
        Private _InventoryTxnID, _InventoryTxnName, _OperandTypeSourceWarehouse As String
...
#End Region
        ...
        Public Overrides Function SelectOne(Optional ByVal recStatus As RavenRecStatus = RavenRecStatus.CurrentRecord) As DataTable
            ...
            cmdToExecute.CommandText = "SELECT * FROM InventoryTxn WHERE InventoryTxnID = @InventoryTxnID"
            ...
            Try
                ...
                If toReturn.Rows.Count > 0 Then
                    ...
                    _InventoryTxnName = CType(toReturn.Rows(0)("InventoryTxnName"), String)
                    _OperandTypeSourceWarehouse = CType(toReturn.Rows(0)("OperandTypeSourceWarehouse"), String)
                    _IsMutation = CType(toReturn.Rows(0)("IsMutation"), Boolean)
...
#Region " Class Property Declarations "
        ...
        Public Property [OperandTypeSourceWarehouse]() As String
            Get
                Return _OperandTypeSourceWarehouse
            End Get
            Set(ByVal Value As String)
                _OperandTypeSourceWarehouse = Value
            End Set
        End Property
