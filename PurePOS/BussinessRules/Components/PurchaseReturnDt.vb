...
#Region " Class Member Declarations "
        Private _ID, _PReturnNO, _ItemSeqNo, _ItemUnitID, _ItemFactor, _Description As String
...
#End Region
        ...
        Public Overrides Function Insert() As Boolean
            ...
            cmdToExecute.CommandText = "INSERT INTO PurchaseReturndt " & _
                                       "(ID, PReturnNO, ItemSeqNo, ItemUnitID, ItemFactor, Description, " & _
                                       ...
                                       "VALUES (@ID, @PReturnNO, @ItemSeqNo, @ItemUnitID, @ItemFactor, left(@Description,500), " & _
                                       "@Qty, @Price, @Disc1Pct, @Disc1Amt, @Disc2Pct, @Disc2Amt, @Disc3Pct, @Disc3Amt, @ReturnFeePct, @ReturnFeeAmt, " & _
