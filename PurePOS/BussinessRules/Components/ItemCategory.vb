...
#Region " Class Member Declarations "
        ...
        Private _SalesDiscountPct, _SalesDiscountAmt, _MarginPct As Decimal
        Private _IsActive, _IsFormula, _IsInventory As Boolean
#End Region
        ...
        Public Overrides Function Insert() As Boolean
            ...
            cmdToExecute.CommandText = "INSERT INTO ItemCategory " & _
                                        "(ItemCategoryID, ItemCategoryName, Description, SalesDiscountPct, SalesDiscountAmt, MarginPct, isActive, IsFormula, IsInventory, UserInsert, InsertDate, UserUpdate, UpdateDate) " & _
                                        "VALUES (@ItemCategoryID, @ItemCategoryName, left(@Description,500), @SalesDiscountPct, @SalesDiscountAmt, @MarginPct, @IsActive, @IsFormula, @IsInventory, @UserInsert, GetDate(), @UserUpdate, GetDate())"
            ...
            Try
                ...
                cmdToExecute.Parameters.Add("@IsFormula", _IsFormula)
                cmdToExecute.Parameters.Add("@IsInventory", _IsInventory)
        ...
        Public Overrides Function Update() As Boolean
            ...
            cmdToExecute.CommandText = "UPDATE ItemCategory " & _
                                        ...
                                        "IsFormula = @IsFormula, " & _
                                        "IsInventory= @IsInventory, " & _
                                        "IsActive = @IsActive, " & _
        ...
        Public Overrides Function SelectOne(Optional ByVal recStatus As RavenRecStatus = RavenRecStatus.CurrentRecord) As DataTable
            ...
            Try
                ...
                If toReturn.Rows.Count > 0 Then
                    ...
                    _IsFormula = CType(toReturn.Rows(0)("IsFormula"), Boolean)
                    _IsInventory = CType(toReturn.Rows(0)("IsInventory"), Boolean)
...
#Region " Custom Functions "
        Public Function SelectAllActive() As DataTable
            ...
            cmdToExecute.CommandText = "SELECT * FROM ItemCategory WHERE isActive = 1"
            cmdToExecute.CommandType = CommandType.Text
