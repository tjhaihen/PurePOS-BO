...
Namespace Raven.Common
    ...
    Public Class HisConfiguration
        ...
        Private Const DATAACCESS_CONNECTIONSTRING_DEFAULT As String = "server=localhost; User ID=sa;database=HIS"
        Private Const DATAACCESS_CONFIGURATION_CONNECTIONSTRING_DEFAULT As String = "server=localhost; User ID=sa;database=RSV2"
        ...
        Private Const CUSTOM_REPORTS_FOLDER_DEFAULT As String = "/Reports/RSV2/"
        Private Const PHYSICAL_REPORTS_FOLDER_DEFAULT As String = ""
        Private Const APP_ID_DEFAULT As String = "RJ_"
        ...
        Implements IConfigurationSectionHandler.Create
            ...
            If settings Is Nothing Then
                ...
                fieldCustomReportsFolder = CUSTOM_REPORTS_FOLDER_DEFAULT
            ...
            Else
                ...
                fieldCustomReportsFolder = ApplicationConfiguration.ReadSetting(settings, CUSTOM_REPORTS_FOLDER, CUSTOM_REPORTS_FOLDER_DEFAULT)
